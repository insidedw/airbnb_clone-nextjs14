      ...
      <form action={CreateDescription}>
        ...
        <div className={'mx-auto w-3/5 mt-10 flex flex-col gap-y-5 mb-36'}>
          <div className={'flex flex-col gap-y-2'}>
            <Label>Title</Label>
            <Input name={'title'} required={true} placeholder={'Short and simple...'} />
          </div>
          <div className={'flex flex-col gap-y-2'}>
            <Label>Description</Label>
            <Textarea name={'description'} required={true} placeholder={'Please describe your home...'} />
          </div>

          <div className={'flex flex-col gap-y-2'}>
            <Label>Price</Label>
            <Input name={'price'} type={'number'} required={true} placeholder={'Price per Night in USD'} min={10} />
          </div>
